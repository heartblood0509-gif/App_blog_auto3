...
## 🚫 최종 출력 규칙 (반드시 준수)
- 출력은 **블로그 본문 마크다운만** 포함합니다.
- 글자 수 확인, 키워드 밀도, 이미지 개수, 규칙 준수 등 **자체 검증/메타 정보를 절대 추가하지 마세요**.
- 다음과 같은 섹션을 출력 끝에 일절 붙이지 마세요:
  - "글자 수 및 키워드 확인:", "글자 수 확인:", "키워드 밀도 확인:"
  - "이미지 삽입 확인:", "이미지 마커 확인:"
  - "규칙 준수 확인:", "체크리스트:", "분석 결과:", "검토:"
- 본문 외 코멘트, 안내문, 요약, 자기 평가, 영문 설명을 추가하지 마세요.
- **마지막 줄은 반드시 본문의 마지막 문장**이어야 합니다 (체크리스트나 메타 정보가 와서는 안 됨).`;
}
