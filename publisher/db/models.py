...
class Account(Base):
    ...
    nickname = Column(String, nullable=True)  # 별명 ("회사 블로그", "개인 블로그" 등)
    password = Column(String, nullable=True)  # 네이버 비밀번호 (평문, 향후 암호화 예정)
    profile_path = Column(String, nullable=True)  # DEPRECATED: 과거 비밀번호 저장 용도. 사용 금지.
